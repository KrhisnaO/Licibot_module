...
urlpatterns = [
    ...
    path('ver_info_licitacion/<str:id>/', views.ver_info_licitacion, name='ver_info_licitacion'),
    path('guardar_respuestas/<str:id>/', views.guardar_respuestas, name='guardar_respuestas'),
]
